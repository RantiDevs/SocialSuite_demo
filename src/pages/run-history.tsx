                      ...
                      <div className="mt-4 pt-4 border-t border-border">
                        ...
                        <div className="space-y-3">
                          {run.entries.map((entry) => (
                            <div key={entry.username} className="p-4 bg-muted/50 rounded-lg border border-border">
                              ...
                              <div className="grid grid-cols-5 gap-2 text-xs">
                                <div>
                                  ...
                                  <p className="font-semibold">{entry.followers.toLocaleString()}</p>
                                </div>
                                <div>
                                  <p className="text-muted-foreground">Following</p>
                                  <p className="font-semibold">{(entry.following || 0).toLocaleString()}</p>
                                </div>
                                <div>
                                  <p className="text-muted-foreground">Posts</p>
                                  <p className="font-semibold">{(entry.mediaCount || 0).toLocaleString()}</p>
                                </div>
                                <div>
                                  <p className="text-muted-foreground">Reels</p>
                                  <p className="font-semibold">{(entry.clipsCount || 0).toLocaleString()}</p>
                                </div>
                                <div>
                                  <p className="text-muted-foreground">Scraped</p>
                                  <p className="font-semibold">{entry.reelsScraped}</p>
                                </div>
                              </div>
                            </div>
                          ))}
